...
public interface VisionImageProcessor {
  ...
  void processBitmap(Bitmap bitmap, edu.psu.pjm6196.inventorymanager.barcodescanner.utils.GraphicOverlay graphicOverlay);

  /** Processes ByteBuffer image data, e.g. used for Camera1 live preview case. */
  void processByteBuffer(
      ByteBuffer data, FrameMetadata frameMetadata, edu.psu.pjm6196.inventorymanager.barcodescanner.utils.GraphicOverlay graphicOverlay)
