...
import edu.psu.pjm6196.inventorymanager.barcodescanner.utils.vision.ChooserActivity
    ...
    findViewById<TextView>(R.id.kotlin_entry_point).setOnClickListener {
      val intent =
        Intent(
          ...
          edu.psu.pjm6196.inventorymanager.barcodescanner.utils.kotlin.ChooserActivity::class.java
        )
      startActivity(intent)
    }
